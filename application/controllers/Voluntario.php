...
class Voluntario extends CI_Controller {
	...
	public function Salvar() {
		...
		if ($retorno > 0) {
			...
			$this->form_validation->set_rules('voluntario_telefone', 'Telefone', 'required|max_length[150]');
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->Voluntario_model->nome_voluntario = $this->input->post('voluntario_nome');
